...
import { Card, CardContent, PizzaInfo } from '@/src/shared/components'
...
export function SuccessView() {
  ...
  const { get, getTotalPrice, clear } = useCartPizzaStorage()
  const [pizzas] = React.useState(get())
  const [totalPrice] = React.useState(getTotalPrice(get()))
