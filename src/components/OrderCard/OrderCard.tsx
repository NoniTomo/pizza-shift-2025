    ...
    <>
      <Card className={`w-full py-4 cursor-pointer px-1 ${variant === 'history' ? 'border-none shadow-none' : 'rounded-3xl border-2 border-solid border-secondary shadow-sm'}`}>
        <CardContent className="flex flex-col gap-3 px-4 py-0">
          <div>
            <p className="text-sm text-secondary-secondary-2">{t('orderStatus')}</p>
            <div className="flex items-center gap-3">
              ...
              <div>{t(`order.statusCode.${order.status}`)}</div>
            </div>
          </div>
          ...
          <div className="flex w-full flex-col gap-1">
            <p className="text-sm text-secondary-secondary-2">{t('orderContains')}</p>
          ...
          <div className="flex flex-col gap-1">
            <p className="text-sm text-secondary-secondary-2 ">{t('orderAmount')}</p>
            <p className="text-base">
